...
namespace WordSpinAlpha.Editor
{
    public static class WordSpinAlphaSceneBuilder
    {
        ...
        private static void BuildGameplayScene(GameObject pinPrefab, GameObject keyPrefab, bool forceReset)
        {
            ...
            GameObject resultRoot = Panel("Result", canvas.transform, new Vector2(0.5f, 0.46f), new Vector2(720, 240), new Color(0.12f, 0.12f, 0.15f, 0.98f)).gameObject;
            TextMeshProUGUI resultLabel = Label("ResultLabel", resultRoot.transform, "Level Complete", 34, new Vector2(0.5f, 0.70f), new Vector2(540, 60), new Color(1f, 0.85f, 0.60f));
            Button next = Button("Next", resultRoot.transform, "Next", new Vector2(0.35f, 0.20f), new Vector2(180, 56), new Color(0.84f, 0.43f, 0.16f));
            Button menu = Button("Menu", resultRoot.transform, "Menu", new Vector2(0.65f, 0.20f), new Vector2(180, 56), new Color(0.22f, 0.24f, 0.30f));
